 ...
 */
if(!function_exists('get_ages_from_date')) {
    function get_ages_from_date($from, $to) {
...
if(!function_exists('get_days_by_two_dates')) {
    function get_days_by_two_dates($from, $to) {
        $from = new DateTime($from);
        $to = new DateTime($to);
        $interval = $to->diff($from);
